...
define config.name = _("FNaF: Neverending Nightmares")
...
define gui.about = _p("""Вот тут надо чета написать. Типа игра крутая такая и замечательная.
""")
...
define config.save_directory = "fnafdemo-1576077670"
